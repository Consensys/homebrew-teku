class Teku < Formula
  ...
  url "https://artifacts.consensys.net/public/teku/raw/names/teku.zip/versions/22.6.0/teku-22.6.0.zip"
  # update with: ./updateTeku.sh <new-version>
  sha256 "b3a3df793504556879b2ff9825c54939ea2b82d9eac767b9bf8f21c2046535a7"
