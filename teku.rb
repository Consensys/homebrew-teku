class Teku < Formula
  ...
  url "https://artifacts.consensys.net/public/teku/raw/names/teku.zip/versions/25.2.0/teku-25.2.0.zip"
  # update with: ./updateTeku.sh <new-version>
  sha256 "7ef4998d874b9f0118ef5b43f79ba42fef54ee328549cf87e38911ed4dc9f70f"
