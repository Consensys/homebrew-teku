class Teku < Formula
  ...
  url "https://artifacts.consensys.net/public/teku/raw/names/teku.zip/versions/23.3.1/teku-23.3.1.zip"
  # update with: ./updateTeku.sh <new-version>
  sha256 "fadc91e193923897930a4d2f81290c45c949749754a5fe2fe27962db9729a228"
